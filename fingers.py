...
# print(f"Dispositivos de cámara disponibles: {cv2.getBuildInformation()}")
...
with mp_hands.Hands(
    ...
    while True:
        ...
        cv2.putText(frame, "Indexx",(160, 80), 1, 1, (255, 255, 255), 2)
        # Heart
        ...
        #------
        cv2.putText(frame, "Press 'E' to exit",(15, 120), 1, 1, (255, 255, 255), 2)
        #------
